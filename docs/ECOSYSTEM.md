...
| Document | Description |
|----------|-------------|
| [tests/README.md](https://github.com/jmagly/agentic-sandbox/blob/main/tests/README.md) | E2E test suite overview and usage |
| [scripts/chaos/README.md](https://github.com/jmagly/agentic-sandbox/blob/main/scripts/chaos/README.md) | Chaos testing framework — 5 experiments: server kill, storage fill, VM kill, network partition, slow clone |
