/**
 * Agentic Sandbox Docs - Terminal Enhancements
 * Keeps the docs.aiwg.io terminal shell while marking this as the sandbox section.
 */
...
const THEME_KEY = 'agentic-sandbox-theme';
...
const COMMANDS = {
  ...
  version: {
    description: 'Show Agentic Sandbox docs version',
    handler: () => appendLogEntry('VERSION', 'Agentic Sandbox Docs v2026.6.0'),
  },
  github: {
    description: 'Open GitHub repository',
    handler: () => {
      window.open('https://github.com/jmagly/agentic-sandbox', '_blank');
  ...
  issues: {
    ...
    handler: () => {
      window.open('https://github.com/jmagly/agentic-sandbox/issues', '_blank');
      appendLogEntry('NAV', 'Opened GitHub issues');
    },
  },
  aiwg: {
    description: 'Open AIWG docs root',
    handler: () => {
      window.open('https://docs.aiwg.io/', '_blank');
      appendLogEntry('NAV', 'Opened AIWG docs root');
    },
  },
};
...
function initContextIndicator() {
  ...
  function updateContext() {
    ...
    indicator.textContent = `sandbox:${hash}`;
  }
...
const WELCOME_SHOWN_KEY = 'agentic-sandbox-welcome-shown';
...
function showWelcomeOnFirstInteraction() {
  ...
  appendLogEntry('SYSTEM', `Agentic Sandbox Documentation Terminal

Welcome to the Agentic Sandbox section of docs.aiwg.io.
