...
Main and tag CI remain the release source of truth. v2026.5.10 should replace v2026.5.9 as the clean automation-control/TUI release once tag E2E is green.
