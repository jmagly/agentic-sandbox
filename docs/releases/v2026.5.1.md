...
**Released:** 2026-05-19
**Tag:** `v2026.5.1`
**Previous:** [`v2026.5.0`](https://github.com/jmagly/agentic-sandbox/releases/tag/v2026.5.0) (2026-05-08)
**Compare:** [`v2026.5.0...v2026.5.1`](https://github.com/jmagly/agentic-sandbox/compare/v2026.5.0...v2026.5.1)
...
- **Binary release artifacts**: this release ships from source only. The following follow-on work is tracked and will land in a subsequent release:
  - [#295](https://github.com/jmagly/agentic-sandbox/issues/295) — pre-release validation gate (P0)
  - [#296](https://github.com/jmagly/agentic-sandbox/issues/296) — cargo publish for the three Rust crates (P1)
  - [#297](https://github.com/jmagly/agentic-sandbox/issues/297) — release binary tarballs + SHA256 sums (P1)
  - [#301](https://github.com/jmagly/agentic-sandbox/issues/301) — automated version bumping across all manifests (P1)
  - [#299](https://github.com/jmagly/agentic-sandbox/issues/299) — multi-registry container push (ghcr + Quay) (P2)
  - [#300](https://github.com/jmagly/agentic-sandbox/issues/300) — signed artifacts + SBOM (P2)
- **Python expunge follow-ups**: the Python SDK (`sdk/python/`) and legacy agent runtime (`agent/`) have been removed. Two intentional Python footholds remain and will be ported to Rust:
  - [#302](https://github.com/jmagly/agentic-sandbox/issues/302) — port `tests/e2e/` pytest harness to Rust integration tests
  - [#303](https://github.com/jmagly/agentic-sandbox/issues/303) — port `scripts/vm-event-bridge.py` to Rust
...
See [`CHANGELOG.md`](https://github.com/jmagly/agentic-sandbox/blob/main/CHANGELOG.md#202651-2026-05-19) for the detailed Added / Fixed / Security / Documentation breakdown.
