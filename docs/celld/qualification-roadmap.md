...
3. Extend the delivered durable provider-dispatch count and UAT-003 external
   provider-state join across restart/response-loss/fencing cases; add
   owner/epoch targeting, per-trial fault barriers, raw timelines, and
