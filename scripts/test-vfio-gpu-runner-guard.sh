...
assert_not_contains "workflow defines no physical VFIO job" "vfio-gpu-hardware" "$workflow"
assert_not_contains "workflow defines no physical-GPU runner label" "vfio-gpu-disabled" "$workflow"
